...
class UtilityNetwork {
      ...
      ///first function one should call after creating an instance of a utility network
       load ()
        ...
        //run connected Trace
        connectedTrace(startingPoints, barriers, direction)
        {
            let traceLocations = [];
            //terminalId  percentAlong: 0

            startingPoints.forEach(s=> traceLocations.push({traceLocationType: "startingPoint", globalId:s.globalId , percentAlong: 0.39741422677691796 } ));
